...
export default class ARDrivingCar extends Component {
  ...
  getJoystick() {
    let rotation =
      "" +
      (this.state.left ? "-" : "") +
      Math.round(this.state.leftRightRatio * 90) +
      "deg";
    ...
    return (
      <View style={styles.joystickContainer}>
        <Image
          style={joystickButtonStyle}
          source={require("./res/steering_wheel.png")}
        />
        <View
    ...
    return (
      ...
      >
        <Image
          ...
          source={require("./res/icon_refresh.png")}
        />
      </TouchableOpacity>
    );
  }
...
let paddingTop = PlatformUtils.isIPhoneX()
  ...
  : 0;
let paddingBottom = PlatformUtils.isIPhoneX()
  ? PlatformUtils.iPhoneXBottomPadding
  : 0;
