...
var InitialARScene = require("./ARHitScene");
...
export default class ARHitApp extends Component {
  constructor() {
    super();
  ...
  _onDisplayDialog() {
    Alert.alert("Choose an object", "Select an object to place in the world!", [
      {
        text: "Flowers",
        onPress: () => this._onShowObject(0, "flowers", 0.29076),
      },
      {
        text: "Smile Emoji",
        onPress: () => this._onShowObject(1, "smile_emoji", 0.497823),
      },
    ]);
  }
